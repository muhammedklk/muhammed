...
const HomeSelectedWorksManager = () => {
  ...
  const handleUpdateProject = async (proj) => {
    ...
    try {
      ...
      await projectsApi.update(proj._id, payload);
      if (refreshPortfolio) {
    ...
    <div style={{ maxWidth: '950px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '28px' }}>
        <div>
          ...
          <p style={{ fontSize: '13.5px', color: '#94a3b8', margin: 0 }}>Exclusively edit the top 4 mockup screenshots, titles, categories, and live website links displayed on your public Home Page.</p>
        </div>
      </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setProjects(prev => prev.map(p => p._id === proj._id ? { ...p, category: newCat, subtitle: newCat, shortDescription: newCat } : p));
                      }}
                      style={{ width: '100%', padding: '10px 14px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '10px', color: '#ffffff' }}
                    />
                  </div>
