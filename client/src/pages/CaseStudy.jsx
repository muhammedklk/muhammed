...
const CaseStudy = () => {
  ...
  const project = dynamicProject
    ? {
        ...
        heroImg: dynamicProject.heroImg || staticProject.heroImg,
        showcaseImg: dynamicProject.showcaseImg || staticProject.showcaseImg,
        ...
        bannerImg: dynamicProject.caseStudy?.bannerImg || dynamicProject.heroImg || staticProject.bannerImg,
