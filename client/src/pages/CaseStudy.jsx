...
const CaseStudy = () => {
  ...
  const project = dynamicProject
    ? {
        ...
        heroImg: dynamicProject.heroImg || dynamicProject.caseStudy?.heroImg || staticProject.heroImg,
        showcaseImg: dynamicProject.showcaseImg || dynamicProject.caseStudy?.showcaseImg || staticProject.showcaseImg,
        mobileImg1: dynamicProject.mobileImg1 || dynamicProject.caseStudy?.mobileImg1 || staticProject.mobileImg1,
        mobileImg2: dynamicProject.mobileImg2 || dynamicProject.caseStudy?.mobileImg2 || staticProject.mobileImg2,
        bannerImg: dynamicProject.caseStudy?.bannerImg || dynamicProject.bannerImg || dynamicProject.heroImg || staticProject.bannerImg,
