  ...
  const safeProjects = Array.isArray(projects) && projects.length > 0 ? projects : [
    {
      ...
      image: '/assets/portfolio/1-styleora.jpg',
    ...
    },
    {
      ...
      image: '/assets/portfolio/2-elve.jpg',
    ...
    },
    {
      ...
      image: '/assets/portfolio/3-greentrack.jpg',
    ...
    },
    {
      ...
      image: '/assets/portfolio/gyogrea.png',
    ...
    <section className="demos-section grid-lines-bg" id="selected-work">
      <div className="container">
        ...
        <div className="demos-header text-center">
          <div className="outlined-stat-num">{safeProjects.length}+</div>
                ...
                <div className="demo-card-item">
                  ...
                  <div className="demo-card-footer" style={{ textAlign: 'center', padding: '16px 4px 0 4px', width: '100%' }}>
                    <div className="demo-title-group" style={{ textAlign: 'center' }}>
                      ...
                      <span className="demo-card-subtext" style={{ display: 'block', fontSize: '13.5px', color: '#64748b', margin: 0, textAlign: 'center', fontWeight: '500' }}>{item.category || item.subtitle || 'UI/UX Design & Development'}</span>
                    </div>
                  </div>
                </div>
              </div>
